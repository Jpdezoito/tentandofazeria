...
def limited_search(
    ...
    wants_image = any(k in q_lower for k in ("imagem", "foto", "figura", "print"))
    wants_video = any(k in q_lower for k in ("video", "vídeo", "filmagem"))
    ...
    if "." in query_text:
        ...
        want_exts.update({".png", ".jpg", ".jpeg", ".bmp", ".gif", ".webp"})
    elif wants_video:
        want_exts.update({".mp4", ".mkv", ".avi", ".mov", ".webm", ".m4v"})
    else:
