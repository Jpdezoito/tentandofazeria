...
def default_paths(root: Path) -> AppPaths:
    return AppPaths(
        root=root,
        conversa=root / "src" / "backend" / "rnas" / "conversa",
        buscarpastas=root / "src" / "backend" / "rnas" / "buscarpastas",
        qualquer_imagem=root / "src" / "backend" / "rnas" / "imagem",
        video=root / "src" / "backend" / "rnas" / "video",
        treinos=root / "src" / "backend" / "data" / "treinos",
        data=root / "src" / "backend" / "data",
        models=root / "src" / "backend" / "models",
        eval_dir=root / "src" / "backend" / "data" / "eval",
        logs=root / "src" / "backend" / "logs",
    )
