...
def _support_from_knowledge(question: str, answer: str, knowledge_db: Path | None) -> tuple[float, bool]:
    ...
    try:
        ...
        from src.rna_de_conversa.core.config import AppConfig
        from src.rna_de_conversa.core.knowledge.retrieval import KnowledgeRetrievalConfig, retrieve_chunks
        from src.rna_de_conversa.core.knowledge.store import iter_chunks
    except Exception:
        return 0.0, False
